  ...
  return (
    <button
      ...
      className={`
        ...
        h-[43px] px-5 sm:px-6 py-2.5 rounded-tl-[20px] rounded-br-[20px] rounded-tr-none rounded-bl-none
        font-orbitron font-semibold text-[18px] leading-[1.5] whitespace-nowrap

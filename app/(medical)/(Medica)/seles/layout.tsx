...
import { Baloo_Thambi_2, Outfit, Orbitron } from "next/font/google";
import "./globals.css";
...
export default function GeotekLayout({
  ...
  return (
    <div
      className={`geotek-root ${baloo.variable} ${outfit.variable} ${orbitron.variable} min-h-screen bg-black antialiased overflow-x-hidden relative w-full`}
    >
      <AOSInit />

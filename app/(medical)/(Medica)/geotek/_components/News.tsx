...
export default function News() {
  ...
  return (
    <section id="news" className="w-full relative z-10 py-14 sm:py-20 md:py-24 bg-white">
          ...
          {newsData.map((item, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-start w-full">
                {/* Event Title */}
                <h3 className="font-baloo font-semibold text-[20px] sm:text-[22px] lg:text-[24px] leading-tight text-[#2A2A2A] capitalize text-left mb-2.5">
                  {item.title}
                </h3>
                ...
                <button
                  ...
                  className="
                    font-baloo font-semibold text-[19px] sm:text-[22px] leading-[150%]

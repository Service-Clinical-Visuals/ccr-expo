...
const Button = ({
  ...
  const content = (
    <div className={`flex items-center justify-center px-6 py-2.5 transition-colors ${variantStyles} ${className}`}>
      <div className="button whitespace-nowrap mr-3 ">{text}</div>
      {showIcon && (
